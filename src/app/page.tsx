  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -top-20 -right-20 w-96 h-96 rounded-full bg-orange-700/10 blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-20 -left-20 w-96 h-96 rounded-full bg-amber-600/10 blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full bg-orange-600/5 blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>

      {/* Header */}
      <header className="relative z-50 px-4 md:px-8 py-6 border-b border-orange-900/20 bg-black/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center shadow-lg shadow-orange-900/30">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">collect Anonymously</p>
            </div>
          </div>
          <div className="flex gap-3">
            <button 
              onClick={handleSignInClick}
              className="px-6 py-2 border border-orange-500/30 text-orange-400 rounded-lg bg-orange-950/10 hover:bg-orange-950/30 hover:border-orange-400/50 transition-all duration-300"
            >
              {hasAccessToken ? 'Dashboard' : 'Sign In'}
            </button>
            <button 
              onClick={handleStartFreeClick}
              className="px-6 py-2 bg-gradient-to-r from-orange-500 to-amber-600 rounded-lg hover:from-orange-600 hover:to-amber-700 text-white font-semibold shadow-md shadow-orange-900/20 hover:shadow-orange-900/40 transition-all duration-300"
            >
      ...
      <main className="relative flex-grow z-10">
        <section className="px-4 md:px-8 py-16 md:py-24">
          <div className="max-w-7xl mx-auto text-center">
            <div className="flex justify-center items-center mb-8">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center shadow-lg shadow-orange-900/30 animate-bounce">
                <Zap className="w-10 h-10 text-white" strokeWidth={1.5} />
              </div>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-amber-600 mb-6">
              FastForwardPolls
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <button 
                ...
                className="px-8 py-4 bg-gradient-to-r from-orange-500 to-amber-600 rounded-xl hover:from-orange-600 hover:to-amber-700 text-white font-semibold shadow-lg shadow-orange-900/20 hover:shadow-orange-900/40 transition-all duration-300 text-lg"
              >
                {hasAccessToken ? 'Go to My Polls' : 'Create Your First Poll'}
              </button>
              <button 
                onClick={handleViewDemoClick}
                className="px-8 py-4 border border-orange-500/30 text-orange-400 rounded-xl bg-orange-950/10 hover:bg-orange-950/30 hover:border-orange-400/50 transition-all duration-300 text-lg"
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
              {/* Bar Chart */}
              <div className="bg-gray-900/80 backdrop-blur-sm border border-orange-500/20 rounded-xl p-6 hover:border-orange-500/40 transition-all duration-300">
        ...
        {/* Poll Types Section */}
        <section className="px-4 md:px-8 py-16 bg-gradient-to-b from-transparent to-gray-900/20">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-amber-600 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {pollTypes.map((poll, index) => (
                <div key={index} className="bg-gray-900/80 backdrop-blur-sm border border-orange-500/20 rounded-xl p-6 hover:border-orange-500/40 hover:transform hover:scale-105 transition-all duration-300 group">
                  <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${poll.color} flex items-center justify-center mb-4 group-hover:shadow-lg transition-all duration-300`}>
                    {React.cloneElement(poll.icon, { className: "w-8 h-8 text-white" })}
                  </div>
                  <h3 className="text-xl font-semibold text-white mb-3">{poll.title}</h3>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <div key={index} className="bg-gray-900/80 backdrop-blur-sm border border-orange-500/20 rounded-xl p-8 hover:border-orange-500/40 hover:transform hover:scale-105 transition-all duration-300 group">
                  <div className="text-orange-500 mb-6 group-hover:text-orange-400 transition-colors duration-300">
                    {feature.icon}
                  </div>
        ...
        <section className="px-4 md:px-8 py-16 bg-gradient-to-b from-gray-900/20 to-transparent">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-amber-600 mb-4">
            ...
            <div className="space-y-6">
              {messages.map((message, index) => (
                <div key={index} className="bg-gray-900/80 backdrop-blur-sm border border-orange-500/20 rounded-xl p-6 hover:border-orange-500/40 transition-all duration-300 animate-pulse" style={{animationDelay: `${index * 0.5}s`}}>
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center flex-shrink-0">
                      <MessageSquare className="w-6 h-6 text-white" />
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <h4 className="text-lg font-semibold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-500">
                          {message.title}
                        </h4>
        ...
        {/* CTA Section */}
        <section className="px-4 md:px-8 py-20 bg-gradient-to-r from-orange-900/10 to-amber-900/10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                ...
                className="px-10 py-4 bg-gradient-to-r from-orange-500 to-amber-600 rounded-xl hover:from-orange-600 hover:to-amber-700 text-white font-semibold shadow-lg shadow-orange-900/20 hover:shadow-orange-900/40 transition-all duration-300 text-lg"
              >
                {hasAccessToken ? 'Go to My Polls' : 'Start Free Trial'}
              </button>
              <button 
                onClick={handleScheduleDemoClick}
                className="px-10 py-4 border border-orange-500/30 text-orange-400 rounded-xl bg-orange-950/10 hover:bg-orange-950/30 hover:border-orange-400/50 transition-all duration-300 text-lg"
              >
      ...
      {/* Footer */}
      <footer className="relative z-10 py-12 bg-gradient-to-b from-transparent to-black border-t border-orange-900/20">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            ...
            <div className="flex flex-col items-center">
              <p className="text-gray-400 font-medium mb-4">Connect with me</p>
              <div className="flex gap-4">
                <a href="https://github.com/devashish2006" target="_blank" rel="noopener noreferrer" 
                   className="w-12 h-12 rounded-full bg-orange-950/20 border border-orange-500/30 flex items-center justify-center text-orange-400 hover:text-orange-300 hover:border-orange-400/50 hover:bg-orange-950/40 hover:scale-110 transition-all duration-300">
          ...
          <div className="pt-8 border-t border-orange-900/10 text-center">
